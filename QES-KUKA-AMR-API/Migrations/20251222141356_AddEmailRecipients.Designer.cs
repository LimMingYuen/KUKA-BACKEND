...
namespace QES_KUKA_AMR_API.Migrations
{
    ...
    [Migration("20251222141356_AddEmailRecipients")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QES_KUKA_AMR_API.Data.Entities.EmailRecipient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QES_KUKA_AMR_API.Data.Entities.IoChannel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool?>("FailSafeValue")
                        .HasColumnType("bit");

                    b.Property<bool>("FsvEnabled")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("DeviceId", "ChannelType", "ChannelNumber")
                        .IsUnique();

                    b.ToTable("IoChannels", (string)null);
                });

            modelBuilder.Entity("QES_KUKA_AMR_API.Data.Entities.IoControllerDevice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("IoControllerDevices", (string)null);
                });

            modelBuilder.Entity("QES_KUKA_AMR_API.Data.Entities.IoStateLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DeviceId", "ChangedUtc");

                    b.HasIndex("DeviceId", "ChannelNumber", "ChannelType");

                    b.ToTable("IoStateLogs", (string)null);
                });
            ...
            modelBuilder.Entity("QES_KUKA_AMR_API.Data.Entities.OrganizationId", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QES_KUKA_AMR_API.Data.Entities.TemplateCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QES_KUKA_AMR_API.Data.Entities.IoChannel", b =>
                {
                    b.HasOne("QES_KUKA_AMR_API.Data.Entities.IoControllerDevice", "Device")
                        .WithMany()
            ...
            modelBuilder.Entity("QES_KUKA_AMR_API.Data.Entities.SavedCustomMission", b =>
                {
                    b.HasOne("QES_KUKA_AMR_API.Data.Entities.TemplateCategory", "Category")
                        .WithMany()
