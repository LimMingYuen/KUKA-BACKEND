...
namespace QES_KUKA_AMR_API.Migrations
{
    ...
    [Migration("20251118151505_AddQueueSystem")]
    partial class AddQueueSystem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QES_KUKA_AMR_API.Data.Entities.MapCodeQueueConfiguration", b =>
                {
                    ...
                    b.HasIndex("MapCode")
                        .IsUnique()
                        .HasDatabaseName("IX_MapCodeQueueConfig_MapCode");
            ...
            modelBuilder.Entity("QES_KUKA_AMR_API.Data.Entities.QueueItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("RequiresOptimization")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("TargetNodeCode")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.HasIndex("MapCode", "Status")
                        .HasDatabaseName("IX_QueueItem_MapStatus");

                    b.HasIndex("MapCode", "Status", "Priority", "QueuePosition")
                        .HasDatabaseName("IX_QueueItem_MapProcessing");
